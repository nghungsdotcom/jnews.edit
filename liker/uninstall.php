...
use Merkulove\Liker\Unity\Cache;
use Merkulove\Liker\Unity\Helper;
use Merkulove\Liker\Unity\Plugin;
use Merkulove\Liker\UninstallHelper;
use Merkulove\Liker\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_liker_migration_settings' ] ) && $uninstall_settings[ 'mdp_liker_migration_settings' ] ) { // Default value.
            $uninstall_settings = [
