...
Class Image
{
    ...
    public static function generate_image_retina($image, $imageretina, $alt, $echo, $image_dm, $imageretina_dm)
    {
        ...
        if ( ( isset( $_COOKIE['darkmode'] ) && $_COOKIE['darkmode'] === 'true' && ($dm_options === 'jeg_toggle_light' || $dm_options === 'jeg_toggle_dark' || $dm_options === 'jeg_timed_dark' || $dm_options === 'jeg_device_dark' || $dm_options === 'jeg_device_toggle' )) || ( $dm_options === 'jeg_full_dark')  || ( !isset( $_COOKIE['darkmode'] ) && $dm_options === 'jeg_toggle_dark' ) )
        {
