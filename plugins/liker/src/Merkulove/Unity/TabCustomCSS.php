...
final class TabCustomCSS extends Tab {
    ...
    public function render_custom_css() {
        ...
        <div>
            <label>
                <textarea id="mdp_custom_css_fld" name="mdp_liker_<?php echo esc_attr( self::TAB_SLUG ); ?>_settings[custom_css]" class="mdp_custom_css_fld"><?php
            ...
            <?php if ( Plugin::get_tabs()[ 'custom_css' ][ 'fields' ][ 'custom_css' ][ 'show_description' ] ) : ?>
                <p class="description"><?php echo apply_filters( 'liker_custom_css_description', Plugin::get_tabs()[ 'custom_css' ][ 'fields' ][ 'custom_css' ][ 'description' ] ); ?></p>
            <?php endif; ?>
        </div>
        <?php
    }
