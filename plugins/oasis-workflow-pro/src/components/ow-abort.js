...
const { PanelBody, Button, Modal, PanelRow, TextareaControl, Spinner } = wp.components;
...
export class AbortWorkflow extends Component {
    ...
    render() {
        ...
        return (
            <PanelBody>
                <Button focus="true" onClick={this.showAbortDialog.bind(this)} isLink>
                    {buttonText}
                </Button>
                {isOpen && (
                    <Modal title={buttonText} onRequestClose={() => this.setState({ isOpen: false })}>
                        ...
                        {success.length !== 0 ? (
                            <div>
                                ...
                                <PanelRow>
                                    <Button isPrimary focus="true" onClick={this.handleClose.bind(this)}>
