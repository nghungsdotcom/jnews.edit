...
/***/ "./src/components/custom-post-type-support.js":
/*!****************************************************!*\
  !*** ./src/components/custom-post-type-support.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CustomPostTypeSupportMessage = function CustomPostTypeSupportMessage(props) {
  return /*#__PURE__*/React.createElement("div", null, __("If this is a custom post type, check this page: ", "oasisworkflow"), /*#__PURE__*/React.createElement("a", {
    target: "_blank",
    href: "https://www.oasisworkflow.com/documentation/working-with-workflows/custom-post-type-support"
  }, "custom post type support"), __(" for more information on how to make custom post type work with Gutenberg Editor.", "oasisworkflow"));
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CustomPostTypeSupportMessage);

/***/ }),

/***/ "./src/components/ow-abort.js":
/*!************************************!*\
  !*** ./src/components/ow-abort.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AbortWorkflow": () => (/* binding */ AbortWorkflow),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
var AbortWorkflow = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(AbortWorkflow, _Component);

  var _super = _createSuper(AbortWorkflow);

  function AbortWorkflow() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, AbortWorkflow);

    _this = _super.apply(this, arguments);
    _this.abort = createRef();
    _this.state = {
    ...
    _this.handleWorkflowAbort = _this.handleWorkflowAbort.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    return _this;
  }
  /**
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(AbortWorkflow, [{
    key: "showAbortDialog",
    value: function showAbortDialog() {
      this.setState({
        isOpen: true
      });
    }
    ...
    key: "handleWorkflowAbort",
    value: function handleWorkflowAbort(event) {
      var _this2 = this;
      ...
      var errors = this.validateAbort(form_data);
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/abort/",
        method: "POST",
        data: form_data
        ...
        if (submitResponse.redirect_link !== "") {
          window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_8___default().sanitize(submitResponse.redirect_link);
        }
      }, function (err) {
        console.log(err);
        return err;
    ...
    key: "validateAbort",
    value: function validateAbort(data) {
      var errors = [];
    ...
    key: "handleClose",
    value: function () {
      var _handleClose = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default().mark(function _callee() {
    ...
    value: function componentDidMount() {
      var _this$props = this.props,
          userCap = _this$props.userCap,
          owSettings = _this$props.owSettings;

      if (userCap.user_can.ow_abort_workflow) {
        var customWorkflowTerminology = owSettings.terminology_settings.oasiswf_custom_workflow_terminology;
        var workflowSettings = this.props.owSettings.workflow_settings;
        ...
        if (workflowSettings) {
          var mandatoryComments = workflowSettings.oasiswf_comments_setting;
          this.setState({
            mandatoryComments: mandatoryComments
          });
        }
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          submitButtonDisable = _this$state.submitButtonDisable,
          submitSpinner = _this$state.submitSpinner,
          validationErrors = _this$state.validationErrors;
      var _this$props2 = this.props,
          isPostInWorkflow = _this$props2.isPostInWorkflow,
          isCurrentPostPublished = _this$props2.isCurrentPostPublished; // if post is NOT in workflow, then do not show abort button

      if (hideButton || !isPostInWorkflow || isCurrentPostPublished) {
        return "";
      }

      return /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        onClick: this.showAbortDialog.bind(this),
        isLink: true
      }, buttonText), isOpen && /*#__PURE__*/React.createElement(Modal, {
        title: buttonText,
      ...
      })) : "", success.length !== 0 ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        id: "owf-success-message",
        className: "notice notice-success is-dismissible"
      }, success.map(function (message) {
        return /*#__PURE__*/React.createElement("p", {
          key: message
        }, message);
      ...
      }, __("Close", "oasisworkflow")))) : /*#__PURE__*/React.createElement("form", {
        className: "reusable-block-edit-panel",
        onSubmit: this.handleWorkflowAbort
      }, /*#__PURE__*/React.createElement(TextareaControl, {
        label: __("Comments", "oasisworkflow") + ":",
        value: this.state.comments,
        onChange: function onChange(comments) {
          return _this3.setState({
            comments: comments
          });
        }
      ...
      }, __("Cancel", "oasisworkflow")), /*#__PURE__*/React.createElement(Button, {
        type: "submit",
        isBusy: this.state.isBusy,
        isPrimary: true,
        disabled: submitButtonDisable,
        focus: "true"
      }, buttonText), submitSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""))));
    }
  }]);

  return AbortWorkflow;
}(Component);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose([withSelect(function (select) {
  var _select = select("core/editor"),
      getCurrentPostId = _select.getCurrentPostId,
      getEditedPostAttribute = _select.getEditedPostAttribute,
      isCurrentPostPublished = _select.isCurrentPostPublished;

  var _select2 = select("plugin/oasis-workflow"),
      getOWSettings = _select2.getOWSettings,
      getUserCapabilities = _select2.getUserCapabilities,
      getPostInWorkflow = _select2.getPostInWorkflow;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ClaimTask": () => (/* binding */ ClaimTask),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
var ClaimTask = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(ClaimTask, _Component);

  var _super = _createSuper(ClaimTask);

  function ClaimTask() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, ClaimTask);
    ...
    _this.handleClaim = _this.handleClaim.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this));
    return _this;
  }
  /**
   * handle form submit for workflow abort
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ClaimTask, [{
    key: "handleClaim",
    value: function handleClaim(event) {
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/claim/",
        method: "POST",
        data: form_data
        ...
        if (claimResponse.isError === "false") {
          var new_history_id = claimResponse.new_history_id;
          var ow_admin_url = claimResponse.url;
          window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_6___default().sanitize(ow_admin_url + "post.php?post=" + postId + "&action=edit&oasiswf=" + new_history_id);
        }
      }, function (err) {
        console.log(err);
        return err;
    ...
    key: "handleRedirectToListPage",
    value: function handleRedirectToListPage() {
      if (this.props.postType === "post") {
        window.location.href = "edit.php";
      } else {
        window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_6___default().sanitize("edit.php?post_type=" + this.props.postType);
      }
    }
    /**
    ...
    key: "handleRedirectToInboxPage",
    value: function handleRedirectToInboxPage() {
      window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_6___default().sanitize("admin.php?page=oasiswf-inbox");
    }
  }, {
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      var _this$state = this.state,
          responseErrors = _this$state.responseErrors,
          hideClaim = _this$state.hideClaim,
          submitSpinner = _this$state.submitSpinner,
          submitButtonDisable = _this$state.submitButtonDisable;
      return /*#__PURE__*/React.createElement("div", null, responseErrors.length !== 0 ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement("div", {
        id: "owf-error-message",
        className: "notice notice-error is-dismissible"
      }, responseErrors.map(function (error) {
        return /*#__PURE__*/React.createElement("p", {
          key: error
        }, error);
      }))), /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("p", {
        className: "post-publish-panel__postpublish-subheader"
      }, /*#__PURE__*/React.createElement("strong", null, __("Other Actions", "oasisworkflow")))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        onClick: this.handleRedirectToListPage.bind(this),
        isLink: true
      }, __("Take me to List page", "oasisworkflow"))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        onClick: this.handleRedirectToInboxPage.bind(this),
        isLink: true
      }, __("Take me to Workflow Inbox", "oasisworkflow"))))) : "", !this.props.isHidden && hideClaim == false ? /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        isPrimary: true,
        disabled: submitButtonDisable,
        onClick: this.handleClaim
      }, __("Claim", "oasisworkflow")), submitSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : "") : "");
    }
  }]);
...
/***/ "./src/components/ow-compare-revision.js":
/*!***********************************************!*\
  !*** ./src/components/ow-compare-revision.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CompareRevision": () => (/* binding */ CompareRevision),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var _wp$data = wp.data,
    ...
    withDispatch = _wp$data.withDispatch;
var compose = wp.compose.compose;
var CompareRevision = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(CompareRevision, _Component);

  var _super = _createSuper(CompareRevision);

  function CompareRevision() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, CompareRevision);

    return _super.apply(this, arguments);
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CompareRevision, [{
    key: "displayRevisionCompare",
    value: function displayRevisionCompare(event) {
      var _this = this;

      // event.preventDefault();
      this.props.onSave();
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/documentRevision/compare",
        method: "GET"
      }).then(function (revisionData) {
        var revision_id = _this.props.postId; // open a popup window with 90% height and width. We will use this window to show the revision compare results.

        var h = screen.height * 90 / 100;
        var w = screen.width * 90 / 100; // link to the revision compare page

        var revisionLink = revisionData.absoluteURL + "post.php?page=oasiswf-revision&revision=" + revision_id + "&_nonce=" + revisionData.nonce;
        var compareWindow = window.open("about:blank", "Revision_Compare", "height=" + h + ",width=" + w + ",scrollbars=yes");
        var link = "".concat(revisionData.revisionPrepareMessage, " <a href='").concat(revisionLink, "'>").concat(revisionData.clickHereText, "</a>");
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/React.createElement("div", null, !this.props.isHidden ? /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        isLink: true,
        onClick: this.displayRevisionCompare.bind(this)
...
/***/ "./src/components/ow-due-date-label.js":
/*!*********************************************!*\
  !*** ./src/components/ow-due-date-label.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OWDueDateLabel": () => (/* binding */ OWDueDateLabel),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/**
 * WordPress Dependencies
...
/***/ "./src/components/ow-due-date-picker.js":
/*!**********************************************!*\
  !*** ./src/components/ow-due-date-picker.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OWDueDatePicker": () => (/* binding */ OWDueDatePicker),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/**
 * WordPress Dependencies
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose([withSelect(function (select) {
  var _select = select("plugin/oasis-workflow"),
      getDueDate = _select.getDueDate;
  ...
  return {
    onUpdateDate: function onUpdateDate(dueDate) {
      dispatch("plugin/oasis-workflow").setDueDate({
        dueDate: dueDate
      });
    }
  };
...
/***/ "./src/components/ow-editorial-comments.js":
/*!*************************************************!*\
  !*** ./src/components/ow-editorial-comments.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EditorialComments": () => (/* binding */ EditorialComments),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var EditorialComments = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(EditorialComments, _Component);

  var _super = _createSuper(EditorialComments);

  function EditorialComments() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, EditorialComments);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(EditorialComments, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      var postId = this.props.postId; // Get Editorial Comments

      wp.apiFetch({
        path: "/oasis-workflow/v1/comments/postId=" + postId,
        method: "GET"
      }).then(function (data) {
        _this2.setState({
    ...
    value: function render() {
      ...
      if (displayComments) {
        return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PanelBody, {
          title: __("Editorial Comments", "oasisworkflow"),
          initialOpen: true
        }, /*#__PURE__*/React.createElement(PanelRow, {
          className: "editorialComments"
...
/***/ "./src/components/ow-make-revision-exist-overlay.js":
/*!**********************************************************!*\
  !*** ./src/components/ow-make-revision-exist-overlay.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MakeRevisionExistOverlay": () => (/* binding */ MakeRevisionExistOverlay),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var _wp$components = wp.components,
    ...
    PanelRow = _wp$components.PanelRow,
    Spinner = _wp$components.Spinner;
var MakeRevisionExistOverlay = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(MakeRevisionExistOverlay, _Component);

  var _super = _createSuper(MakeRevisionExistOverlay);

  function MakeRevisionExistOverlay() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MakeRevisionExistOverlay);

    return _super.apply(this, arguments);
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MakeRevisionExistOverlay, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React.createElement(Modal, {
        title: this.props.buttonText,
        onRequestClose: this.props.revisionExist
      }, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("p", null, __("An active revision already exists for this article. Do you want to delete the existing revised article and create a new revision?", "oasisworkflow"))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(Button, {
        isLink: true,
        disabled: this.props.revisionCancelDisable,
        onClick: this.props.revisionExist
      }, __("Cancel", "oasisworkflow")), /*#__PURE__*/React.createElement(Button, {
        type: "submit",
        isPrimary: true,
        focus: "true",
      ...
      }, __("No, take me to the revision", "oasisworkflow")), /*#__PURE__*/React.createElement(Button, {
        type: "submit",
        isPrimary: true,
        focus: "true",
        disabled: this.props.revisionOkDisable,
        onClick: this.props.deleteRevision
      }, __("Yes, delete it and create new one", "oasisworkflow")), this.props.submitSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""));
    }
  }]);

  return MakeRevisionExistOverlay;
}(Component);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MakeRevisionExistOverlay);

/***/ }),

/***/ "./src/components/ow-make-revision-overlay.js":
/*!****************************************************!*\
  !*** ./src/components/ow-make-revision-overlay.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MakeRevisionOverlay": () => (/* binding */ MakeRevisionOverlay),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var _wp$components = wp.components,
    ...
    PanelRow = _wp$components.PanelRow,
    Spinner = _wp$components.Spinner;
var MakeRevisionOverlay = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(MakeRevisionOverlay, _Component);

  var _super = _createSuper(MakeRevisionOverlay);

  function MakeRevisionOverlay() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MakeRevisionOverlay);

    return _super.apply(this, arguments);
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MakeRevisionOverlay, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React.createElement(Modal, {
        title: this.props.buttonText,
        onRequestClose: this.props.pageBack
      }, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("p", null, __(this.props.revisionOverlayText))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(Button, {
        isLink: true,
      ...
      }, this.props.buttonText), this.props.submitSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""));
    }
  }]);

  return MakeRevisionOverlay;
}(Component);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MakeRevisionOverlay);

/***/ }),

/***/ "./src/components/ow-make-revision.js":
/*!********************************************!*\
  !*** ./src/components/ow-make-revision.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MakeRevision": () => (/* binding */ MakeRevision),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/esm/possibleConstructorReturn.js");
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js");
/* harmony import */ var _ow_make_revision_overlay__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ow-make-revision-overlay */ "./src/components/ow-make-revision-overlay.js");
/* harmony import */ var _ow_make_revision_exist_overlay__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ow-make-revision-exist-overlay */ "./src/components/ow-make-revision-exist-overlay.js");
...
var MakeRevision = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(MakeRevision, _Component);

  var _super = _createSuper(MakeRevision);

  function MakeRevision() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MakeRevision);
    ...
    _this.state = {
      ...
      revisionOverlayText: __("You may not make changes to this published content. You must first make a revision and then submit your changes for approval.", "oasisworkflow"),
      revisionPostId: null,
      revisionExist: false,
      adminURL: "",
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MakeRevision, [{
    key: "checkExistingRevision",
    value: function checkExistingRevision(event) {
      var _this2 = this;
      ...
      wp.apiFetch({
        ...
        var ow_admin_url = revisionData.url;

        if (!revisionData.revisionExist) {
          _this2.savePostAsDraft();
        } else {
          // Revision exist
          _this2.setState({
    ...
    key: "takeToExistingRevision",
    value: function takeToExistingRevision() {
      this.setState({
    ...
    key: "savePostAsDraft",
    value: function savePostAsDraft() {
      var formData = {
        post_id: this.props.postId
      };
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/documentRevision/",
        method: "POST",
        data: formData
      }).then(function (submitResponse) {
    ...
    key: "deleteRevision",
    value: function deleteRevision(event) {
      var _this3 = this;
    ...
    value: function componentDidMount() {
      ...
      var postId = this.props.postId;
      var customWorkflowTerminology = this.props.owSettings.terminology_settings.oasiswf_custom_workflow_terminology;
      var revisionSettings = this.props.owSettings.document_revision_settings;

      if (customWorkflowTerminology) {
        var revisionButtonText = customWorkflowTerminology.makeRevisionText;
        this.setState({
          revisionButtonText: revisionButtonText
        });
      }

      if (revisionSettings) {
        var revisionOverlayText = revisionSettings.oasiswf_revise_post_make_revision_overlay;
        this.setState({
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          showRevisionOverlay = _this$state.showRevisionOverlay,
          revisionExist = _this$state.revisionExist,
          revisionButtonText = _this$state.revisionButtonText,
          revisionOverlayText = _this$state.revisionOverlayText,
          revisionCancelDisable = _this$state.revisionCancelDisable,
          revisionNoDisable = _this$state.revisionNoDisable,
          revisionOkDisable = _this$state.revisionOkDisable,
          submitSpinner = _this$state.submitSpinner,
          revisionButtonDisable = _this$state.revisionButtonDisable;
      var _this$props = this.props,
          isCurrentPostPublished = _this$props.isCurrentPostPublished,
          isCurrentPostScheduled = _this$props.isCurrentPostScheduled;

      if (!isCurrentPostPublished && !isCurrentPostScheduled) {
        return "";
      }

      return /*#__PURE__*/React.createElement("div", null, showButton ? /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(Button, {
        isPrimary: true,
        focus: "true",
        onClick: this.checkExistingRevision.bind(this)
      }, revisionButtonText)) : "", showRevisionOverlay && /*#__PURE__*/React.createElement(_ow_make_revision_overlay__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      }), revisionExist && /*#__PURE__*/React.createElement(_ow_make_revision_exist_overlay__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/***/ "./src/components/ow-pre-publish-checklist.js":
/*!****************************************************!*\
  !*** ./src/components/ow-pre-publish-checklist.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PrePublishChecklist": () => (/* binding */ PrePublishChecklist),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var PrePublishChecklist = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(PrePublishChecklist, _Component);

  var _super = _createSuper(PrePublishChecklist);

  function PrePublishChecklist() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, PrePublishChecklist);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(PrePublishChecklist, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, __("Pre Publish Checklist ", "oasisworkflow") + ":"), this.props.checklist.map(function (item) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Reassign": () => (/* binding */ Reassign),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
...
var Reassign = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Reassign, _Component);

  var _super = _createSuper(Reassign);

  function Reassign() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, Reassign);

    _this = _super.apply(this, arguments);
    _this.reassign = createRef();
    _this.state = {
      ...
      availableAssignees: [],
      selectedAssignees: [],
      actionHistoryId: (0,_util__WEBPACK_IMPORTED_MODULE_8__.getActionHistoryIdFromURL)(),
      taskUser: (0,_util__WEBPACK_IMPORTED_MODULE_8__.getTaskUserFromURL)(),
      comments: "",
    ...
    _this.handleReassign = _this.handleReassign.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    return _this;
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Reassign, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      if (customWorkflowTerminology) {
        var assignActorLabel = customWorkflowTerminology.assignActorsText;
        this.setState({
          assignActorLabel: assignActorLabel
        });
      }
      ...
      var userCap = this.props.userCap;
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/reassign/assignees/actionHistoryId=" + this.state.actionHistoryId + "/taskUser=" + this.state.taskUser,
        method: "GET"
      }).then(function (results) {
        if (results.assignee_count !== 0) {
          var availableAssignees = [];
          var assignees = results.user_info;
          var assigneeData = assignees.map(function (users) {
            return pick(users, ["ID", "name"]);
          });
          assigneeData.map(function (users) {
    ...
    key: "showReassignModal",
    value: function showReassignModal() {
      this.setState({
        isOpen: true
      });
    }
    ...
    key: "handleReassign",
    value: function () {
      var _handleReassign = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default().mark(function _callee(event) {
        var _this3 = this;

        var form_data, errors;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                form_data = {
                  ...
                  assignees: this.state.selectedAssignees.map(function (assignee) {
              ...
              case 5:
                errors = this.validateReassign(form_data);
              ...
              case 11:
                ...
                wp.apiFetch({
                  path: "/oasis-workflow/v1/workflows/reassign/",
                  method: "POST",
                  data: form_data
                }).then(function (submitResponse) {
                  if (submitResponse.isError == true) {
                    ...
                    _this3.reassign.current.scrollIntoView();
                  } else {
                    console.log('holla');
                    ...
                    if (submitResponse.redirect_link !== "") {
                      window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_9___default().sanitize(submitResponse.redirect_link);
                    }
                  }
                }, function (err) {
                  console.log(err);
      ...
      function handleReassign(_x) {
        return _handleReassign.apply(this, arguments);
      }

      return handleReassign;
    }()
  }, {
    key: "validateReassign",
    value: function validateReassign(data) {
      var errors = [];
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          buttonText = _this$state.buttonText,
          isOpen = _this$state.isOpen,
          assignActorLabel = _this$state.assignActorLabel,
          noAssigneeMessage = _this$state.noAssigneeMessage,
          submitSpinner = _this$state.submitSpinner,
          submitButtonDisable = _this$state.submitButtonDisable,
          validationErrors = _this$state.validationErrors,
          hideForm = _this$state.hideForm,
          successMessage = _this$state.successMessage;
      var _this$props = this.props,
          isPostInWorkflow = _this$props.isPostInWorkflow,
          isCurrentPostPublished = _this$props.isCurrentPostPublished; // if post is NOT in workflow, then do not show abort button
      ...
      return /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        onClick: this.showReassignModal.bind(this),
        isLink: true
      }, buttonText), isOpen && /*#__PURE__*/React.createElement(Modal, {
        ref: this.reassign,
        title: buttonText,
      ...
      })) : "", noAssigneeMessage == "show" ? /*#__PURE__*/React.createElement("div", {
        id: "owf-error-message",
        className: "notice notice-error is-dismissible"
      }, __("No users found to reassign", "oasisworkflow")) : "", successMessage !== "" ? /*#__PURE__*/React.createElement("div", {
        id: "owf-success-message",
        className: "notice notice-success is-dismissible"
      }, /*#__PURE__*/React.createElement("p", {
        key: successMessage
      }, successMessage)) : "", !hideForm && /*#__PURE__*/React.createElement("form", {
        className: "reusable-block-edit-panel owf-reassign",
        onSubmit: this.handleReassign
      }, /*#__PURE__*/React.createElement("div", {
        className: "ow-select2-wrap"
      }, /*#__PURE__*/React.createElement("label", {
        htmlFor: 'assignActor'
      }, assignActorLabel + ":"), /*#__PURE__*/React.createElement(react_select__WEBPACK_IMPORTED_MODULE_10__["default"], {
        inputId: "assignActor",
        className: "ow-select2",
        value: this.props.value,
        options: this.state.availableAssignees,
        onChange: function onChange(selectedAssignees) {
          return _this4.setState({
            selectedAssignees: selectedAssignees
          });
        },
        isMulti: "true"
      }), /*#__PURE__*/React.createElement("span", null, __("select actor(s) to reassign the task", "oasisworkflow"))), /*#__PURE__*/React.createElement(TextareaControl, {
        label: __("Comments", "oasisworkflow") + ":",
        value: this.state.comments,
        onChange: function onChange(comments) {
          return _this4.setState({
...
/***/ "./src/components/ow-signoff-last-step.js":
/*!************************************************!*\
  !*** ./src/components/ow-signoff-last-step.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SignoffLastStep": () => (/* binding */ SignoffLastStep),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
...
/* harmony import */ var _ow_pre_publish_checklist__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ow-pre-publish-checklist */ "./src/components/ow-pre-publish-checklist.js");
...
var _wp$editor = wp.editor,
    PostScheduleLabel = _wp$editor.PostScheduleLabel,
    PostSchedule = _wp$editor.PostSchedule;
...
var SignoffLastStep = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(SignoffLastStep, _Component);

  var _super = _createSuper(SignoffLastStep);

  function SignoffLastStep() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, SignoffLastStep);
    ...
    _this.state = {
      ...
      comments: "",
      actionHistoryId: (0,_util__WEBPACK_IMPORTED_MODULE_9__.getActionHistoryIdFromURL)(),
      taskUser: (0,_util__WEBPACK_IMPORTED_MODULE_9__.getTaskUserFromURL)(),
      isImmediatelyChecked: false,
      originalPublishDate: _this.props.publishDate,
      selectedChecklist: [],
      validationErrors: [],
      errorType: "",
      byPassWarning: false,
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(SignoffLastStep, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var customWorkflowTerminology = this.props.owSettings.terminology_settings.oasiswf_custom_workflow_terminology;

      if (customWorkflowTerminology) {
        var signoffButtonText = customWorkflowTerminology.signOffText;
        var continueToSignoffText = customWorkflowTerminology.continueToSignoffText;
        this.setState({
          signoffButtonText: signoffButtonText,
          continueToSignoffText: continueToSignoffText
        });
      }
    }
    /**
    ...
    key: "selectPrePublishChecklist",
    value: function selectPrePublishChecklist(checklist) {
      // Get current state
      var options = this.state.selectedChecklist;
      var index; // check if the check box is checked or unchecked
    ...
    key: "handleContinueToSignoff",
    value: function handleContinueToSignoff(event) {
      var _this2 = this;
    ...
    key: "validateSignoff",
    value: function validateSignoff(data) {
      var errors = [];

      if (typeof window.acf !== "undefined") {
        // Check if ACF field valid or not if they exists
        var ACFCheck = window.workflowSubmitWithACF(); // example
    ...
    key: "handleWorkflowComplete",
    value: function () {
      var _handleWorkflowComplete = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default().mark(function _callee(event) {
        var form_data, errors, that;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                errors = this.validateSignoff(form_data);
      ...
      function handleWorkflowComplete(_x) {
        return _handleWorkflowComplete.apply(this, arguments);
      }
    ...
    key: "redirectTrigger",
    value: function redirectTrigger(url) {
      this.setState({
        loader: "show"
      });
      window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_7___default().sanitize(url);
    } // page refresh invoke

  }, {
    key: "refreshTrigger",
    value: function refreshTrigger(response) {
      this.props.handleResponse(response);
      this.props.pageRefresh();
    }
  }, {
    key: "invokeSignoffAPI",
    value: function invokeSignoffAPI(form_data) {
      var _this3 = this;
      ...
      wp.apiFetch({
        ...
        if (submitResponse.success_response == false) {
          ...
          var evt = new CustomEvent("ow_workflow_completed", {
            detail: submitResponse
          });
          document.dispatchEvent(evt); // Redirect user to inbox page

          if (submitResponse.redirect_link !== "") {
            // update post with laststep status.
            var postUpdate = /*#__PURE__*/function () {
              var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default().mark(function _callee2() {
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default().wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _context2.next = 2;
                        return _this3.props.editPost({
                          status: submitResponse.new_post_status
                        });
                      ...
                      case 4:
                        _this3.redirectTrigger(submitResponse.redirect_link);
            ...
            // update post with laststep status.
            var _postUpdate = /*#__PURE__*/function () {
              var _ref2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default().mark(function _callee3() {
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_6___default().wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 4:
                        _this3.refreshTrigger(submitResponse);
    ...
    key: "handleWorkflowCancel",
    value: function handleWorkflowCancel(event) {
      var _this4 = this;
      ...
      wp.apiFetch({
        ...
        _this4.props.handleResponse(submitResponse);
      }, function (err) {
        console.log(err);
        return err;
      });
    ...
    key: "onImmediatelyChange",
    value: function onImmediatelyChange(checked) {
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          isImmediatelyChecked = _this$state.isImmediatelyChecked,
          signoffButtonText = _this$state.signoffButtonText,
          continueToSignoffText = _this$state.continueToSignoffText,
          validationErrors = _this$state.validationErrors,
      ...
      if (loader === "show") {
        return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PanelBody, null, __("redirecting...", "oasisworkflow")));
      }

      return /*#__PURE__*/React.createElement("div", null, validationErrors.length !== 0 ? /*#__PURE__*/React.createElement("div", {
        id: "owf-error-message",
        className: "notice notice-error is-dismissible"
      }, validationErrors.map(function (error) {
        return /*#__PURE__*/React.createElement("p", {
      ...
      }), errorType == "warning" ? /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement(Button, {
        isSecondary: true,
        focus: "true",
        onClick: this.handleContinueToSignoff.bind(this)
      }, continueToSignoffText)) : "") : "", this.props.stepDecision === "success" ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("div", {
        id: "owf-success-message",
        className: "notice notice-warning is-dismissible"
      }, /*#__PURE__*/React.createElement("p", null, __("This is the last step in the workflow. Are you sure to complete the workflow?", "oasisworkflow")), postMeta && postMeta._oasis_original ? /*#__PURE__*/React.createElement("p", null, " ", __("Signing off will copy over the contents of this revised article to the corresponding published/original article. This will happen either immediately or on the scheduled date/time.", "oasisworkflow")) : "")), this.props.checklist.length !== 0 ? /*#__PURE__*/React.createElement(_ow_pre_publish_checklist__WEBPACK_IMPORTED_MODULE_8__["default"], {
        checklist: this.props.checklist,
        onChange: this.selectPrePublishChecklist.bind(this)
      }) : "", /*#__PURE__*/React.createElement(PanelRow, {
        className: "edit-post-post-schedule"
      }, /*#__PURE__*/React.createElement("label", null, __("Publish", "oasisworkflow") + ":", " "), /*#__PURE__*/React.createElement(Dropdown, {
        ...
        renderToggle: function renderToggle(_ref3) {
          ...
          return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(Button, {
            ...
            "aria-live": "polite",
            isLink: true
          }, /*#__PURE__*/React.createElement(PostScheduleLabel, null)));
        },
        renderContent: function renderContent() {
          return /*#__PURE__*/React.createElement(PostSchedule, null);
        }
      ...
      }, signoffButtonText))) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("div", {
        id: "owf-success-message",
        className: "notice notice-error is-dismissible"
      }, /*#__PURE__*/React.createElement("p", null, __("There are no further steps defined in the workflow. Do you want to cancel the post/page from the workflow?", "oasisworkflow")))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(TextareaControl, {
        label: __("Comments", "oasisworkflow") + ":",
        value: this.state.comments,
        onChange: function onChange(comments) {
...
/***/ "./src/components/ow-signoff-response.js":
/*!***********************************************!*\
  !*** ./src/components/ow-signoff-response.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SignoffResponse": () => (/* binding */ SignoffResponse),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var SignoffResponse = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(SignoffResponse, _Component);

  var _super = _createSuper(SignoffResponse);

  function SignoffResponse() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, SignoffResponse);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SignoffResponse, [{
    key: "handleRedirectToListPage",
    value: function handleRedirectToListPage() {
      if (this.props.postType === "post") {
        window.location.href = "edit.php";
      } else {
        window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_5___default().sanitize("edit.php?post_type=" + this.props.postType);
      }
    }
    /**
     * handle redirect to inbox page
    ...
    key: "handleRedirectToInboxPage",
    value: function handleRedirectToInboxPage() {
      window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_5___default().sanitize("admin.php?page=oasiswf-inbox");
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement("div", {
        id: "owf-success-message",
        className: "notice notice-success is-dismissible"
      }, this.props.response)), /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("p", {
        className: "post-publish-panel__postpublish-subheader"
      }, /*#__PURE__*/React.createElement("strong", null, __("What’s next?", "oasisworkflow")))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(Button, {
        focus: "true",
        onClick: this.handleRedirectToListPage.bind(this),
        isLink: true
      }, __("Take me to List page", "oasisworkflow"))), /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement(Button, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Signoff": () => (/* binding */ Signoff),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _ow_task_priority_select_control__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ow-task-priority-select-control */ "./src/components/ow-task-priority-select-control.js");
/* harmony import */ var _ow_due_date_picker__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ow-due-date-picker */ "./src/components/ow-due-date-picker.js");
/* harmony import */ var _ow_due_date_label__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ow-due-date-label */ "./src/components/ow-due-date-label.js");
/* harmony import */ var _ow_signoff_last_step__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ow-signoff-last-step */ "./src/components/ow-signoff-last-step.js");
/* harmony import */ var _ow_pre_publish_checklist__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ow-pre-publish-checklist */ "./src/components/ow-pre-publish-checklist.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../util */ "./src/util.js");
/* harmony import */ var _images_help_png__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../images/help.png */ "./src/images/help.png");
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! dompurify */ "./node_modules/dompurify/dist/purify.js");
...
var Signoff = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Signoff, _Component);

  var _super = _createSuper(Signoff);

  function Signoff() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Signoff);

    _this = _super.apply(this, arguments);
    _this.signoffPanelRef = createRef();
    _this.state = {
      signoffButtonText: __("Sign Off", "oasisworkflow"),
      ...
      selectedAssignees: [],
      assignToAll: false,
      actionHistoryId: (0,_util__WEBPACK_IMPORTED_MODULE_13__.getActionHistoryIdFromURL)(),
      taskUser: (0,_util__WEBPACK_IMPORTED_MODULE_13__.getTaskUserFromURL)(),
      comments: "",
      isLastStep: false,
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Signoff, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      var customWorkflowTerminology = this.props.owSettings.terminology_settings.oasiswf_custom_workflow_terminology;
      var workflowSettings = this.props.owSettings.workflow_settings;
      var currentPriority = this.props.postMeta != undefined ? this.props.postMeta._oasis_task_priority : "2normal";
      ...
      if (customWorkflowTerminology) {
        var signoffButtonText = customWorkflowTerminology.signOffText;
        var assignActorLabel = customWorkflowTerminology.assignActorsText;
        var dueDateLabel = customWorkflowTerminology.dueDateText;
        var continueToSignoffText = customWorkflowTerminology.continueToSignoffText;
        this.setState({
          signoffButtonText: signoffButtonText,
          assignActorLabel: assignActorLabel,
      ...
      if (workflowSettings) {
        var displayDueDate = workflowSettings.oasiswf_default_due_days;
        var mandatoryComments = workflowSettings.oasiswf_comments_setting; // set the default due date by using the workflow settings
      ...
      wp.apiFetch({
        ...
        method: "GET"
      }).then(function (step_decision) {
        var success_action = step_decision.success_action;
        var failure_action = step_decision.failure_action;

        _this2.setState({
          actions: (0,_util__WEBPACK_IMPORTED_MODULE_13__.getSignOffActions)(success_action, failure_action)
        });
      }, function (err) {
        console.log(err);
        return err;
    ...
    key: "getSignoffSteps",
    value: function getSignoffSteps(stepDecision) {
      var _this3 = this;

      var postId = this.props.postId;
      var decision = "success"; // Set selected stepDecision
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/signoff/nextSteps/actionHistoryId=" + this.state.actionHistoryId + "/decision=" + decision + "/postId=" + postId,
        method: "GET"
        ...
        if (stepdata.steps === "") {
          ...
          var steps = stepdata.steps.map(function (step) {
            return pick(step, ["step_id", "step_name"]);
          });
          var signoffSteps = []; // if there is more than one possible next step
          ...
          if (steps.length == 1) {
            _this3.getSelectedStepDetails(signoffSteps[0]["value"]);
        ...
        var customData = stepdata.custom_data;
        var allChecklist = []; // Get checklist

        if (customData.length !== 0) {
          var checklistData = customData.map(function (checklist) {
            return pick(checklist, ["condition", "value"]);
          });
          checklistData.map(function (checklist) {
            allChecklist.push({
    ...
    key: "getSelectedStepDetails",
    value: function getSelectedStepDetails(stepId) {
      var _this4 = this;
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/signoff/stepDetails/actionHistoryId=" + this.state.actionHistoryId + "/stepId=" + stepId + "/postId=" + postId,
        method: "GET"
      }).then(function (stepdata) {
        var errors = [];
        var availableAssignees = [];
        var assignToAll = stepdata.assign_to_all === 1 ? true : false;
        var teamId = stepdata.team_id;

        if (teamId !== "") {
          _this4.handleTeamChange(teamId, stepId);
        }

        _this4.props.setDueDate({
          dueDate: stepdata.due_date
        }); // If not set team than display step assignee


        if (teamId == "") {
          var assignees = stepdata.users; // Display Validation Message if no user found for the step
          ...
          if (assignees.length === 0) {
            ...
            _this4.signoffPanelRef.current.scrollIntoView();

            return;
          } // Set and Get Assignees from the util function


          var stepAssignees = (0,_util__WEBPACK_IMPORTED_MODULE_13__.getStepAssignees)({
            assignees: assignees,
    ...
    key: "handleOnPriorityChange",
    value: function handleOnPriorityChange(selectedPriority) {
      this.setState({
    ...
    value: function handleTeamChange(selectedTeam) {
      var _this5 = this;

      var slectedStepId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var postId = this.props.postId;
      var stepId = slectedStepId;
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/teams/members/teamId=" + selectedTeam + "/postId=" + postId + "/stepId=" + stepId,
        method: "GET"
      }).then(function (teamdata) {
        var errors = [];
        var assignees = teamdata.users; // Display Validation Message if no user found for the selected team
        ...
        if (assignees.length === 0) {
          ...
          _this5.signoffPanelRef.current.scrollIntoView();
        ...
        var stepAssignees = (0,_util__WEBPACK_IMPORTED_MODULE_13__.getStepAssignees)({
          assignees: assignees,
          assignToAll: _this5.state.assignToAll
        });
    ...
    value: function validateSignoff(data) {
      ...
      var due_date = moment(data.due_date).format("YYYY-MM-DD");
    ...
    key: "handleSignoff",
    value: function () {
      var _handleSignoff = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default().mark(function _callee() {
        var _this7 = this;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                this.unsubscribe = subscribe(function () {
                  var isSavingPost = _this7.props.isSavingPost;
                  var isAutosavingPost = _this7.props.isAutosavingPost; // Define if isAutosavingPost && isSavingPost are done.

                  var savingDone = !isAutosavingPost && !isSavingPost;
      ...
      function handleSignoff() {
        return _handleSignoff.apply(this, arguments);
      }

      return handleSignoff;
    }()
  }, {
    key: "invokeSignoffAPI",
    value: function invokeSignoffAPI(form_data) {
      ...
      wp.apiFetch({
        ...
        if (submitResponse.success_response == false) {
          ...
          _this8.signoffPanelRef.current.scrollIntoView();
        } else {
          if (submitResponse.new_action_history_id != _this8.state.actionHistoryId) {
            _this8.setState({
              hideSignOff: true,
          ...
          if (submitResponse.redirect_link !== "") {
            window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_15___default().sanitize(submitResponse.redirect_link);
          } else {
            _this8.props.handleResponse(submitResponse);
          }
        }
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          validationErrors = _this$state.validationErrors,
          errorType = _this$state.errorType,
          isLastStep = _this$state.isLastStep,
          lastStepDecision = _this$state.lastStepDecision,
          hideSignOff = _this$state.hideSignOff,
          signoffButtonText = _this$state.signoffButtonText,
          continueToSignoffText = _this$state.continueToSignoffText,
          assignActorLabel = _this$state.assignActorLabel,
          dueDateLabel = _this$state.dueDateLabel,
          displayDueDate = _this$state.displayDueDate,
          articleChecklist = _this$state.articleChecklist,
          redirectingLoader = _this$state.redirectingLoader,
          stepSpinner = _this$state.stepSpinner,
          assigneeSpinner = _this$state.assigneeSpinner,
          submitSpinner = _this$state.submitSpinner,
          submitButtonDisable = _this$state.submitButtonDisable;
      ...
      return /*#__PURE__*/React.createElement(PanelBody, {
        ref: this.signoffPanelRef,
        initialOpen: true,
        title: signoffButtonText
        ...
        focus: "true",
        onClick: this.handleContinueToSignoff.bind(this)
      }, continueToSignoffText)) : "") : "", /*#__PURE__*/React.createElement("label", null, __("Action", "oasisworkflow") + ": ", /*#__PURE__*/React.createElement("a", {
        href: "#",
        title: __("After completing or reviewing the post/article, select appropriate action.", "oasisworkflow"),
        className: "tooltip"
      }, /*#__PURE__*/React.createElement("span", {
        title: ""
      }, /*#__PURE__*/React.createElement("img", {
        src: _images_help_png__WEBPACK_IMPORTED_MODULE_14__["default"],
        className: "help-icon"
      })))), /*#__PURE__*/React.createElement(SelectControl, {
        value: this.state.selectedAction,
        options: this.state.actions,
        onChange: this.getSignoffSteps.bind(this)
      }), isLastStep ? /*#__PURE__*/React.createElement(_ow_signoff_last_step__WEBPACK_IMPORTED_MODULE_11__["default"], {
        stepDecision: lastStepDecision,
        handleResponse: this.props.handleResponse,
        checklist: articleChecklist
      }) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, stepSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""), /*#__PURE__*/React.createElement("label", null, __("Step", "oasisworkflow") + ": ", /*#__PURE__*/React.createElement("a", {
        href: "#",
        title: __("Your action will push the Post/Article to the below listed next step.", "oasisworkflow"),
        className: "tooltip"
      }, /*#__PURE__*/React.createElement("span", {
        title: ""
      }, /*#__PURE__*/React.createElement("img", {
      ...
      }), /*#__PURE__*/React.createElement(_ow_task_priority_select_control__WEBPACK_IMPORTED_MODULE_8__["default"], {
        value: this.state.selectedPriority,
        onChange: this.handleOnPriorityChange.bind(this)
      }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, assigneeSpinner == "show" && this.state.assignToAll == false ? /*#__PURE__*/React.createElement(Spinner, null) : ""), !this.state.assignToAll && this.state.selectedAction !== "" ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
        htmlFor: 'assignActor'
      }, assignActorLabel + ":"), /*#__PURE__*/React.createElement(react_select__WEBPACK_IMPORTED_MODULE_16__["default"], {
        inputId: "assignActor",
        styles: style,
        className: "ow-select2",
        ...
        isMulti: "true"
      })) : ""), articleChecklist.length !== 0 ? /*#__PURE__*/React.createElement(_ow_pre_publish_checklist__WEBPACK_IMPORTED_MODULE_12__["default"], {
        checklist: articleChecklist,
        onChange: this.selectPrePublishChecklist.bind(this)
      }) : "", displayDueDate !== "" ? /*#__PURE__*/React.createElement(PanelRow, {
        className: "edit-post-post-schedule"
      }, /*#__PURE__*/React.createElement("label", null, dueDateLabel + ":", " "), /*#__PURE__*/React.createElement(Dropdown, {
        position: "bottom left",
        ...
        renderToggle: function renderToggle(_ref) {
          ...
          return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(Button, {
            ...
            "aria-live": "polite",
            isLink: true
          }, /*#__PURE__*/React.createElement(_ow_due_date_label__WEBPACK_IMPORTED_MODULE_10__["default"], null)));
        },
        renderContent: function renderContent() {
          return /*#__PURE__*/React.createElement(_ow_due_date_picker__WEBPACK_IMPORTED_MODULE_9__["default"], null);
        }
      })) : "", /*#__PURE__*/React.createElement(PanelRow, null, /*#__PURE__*/React.createElement("label", null, __("Comments", "oasisworkflow") + ": ", /*#__PURE__*/React.createElement("a", {
        href: "#",
      ...
      }, signoffButtonText), /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, submitSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : "")))));
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose([withSelect(function (select) {
  ...
  var _select2 = select("plugin/oasis-workflow"),
      getDueDate = _select2.getDueDate,
      getOWSettings = _select2.getOWSettings,
      getPostInWorkflow = _select2.getPostInWorkflow;
...
/***/ "./src/components/ow-submit-to-workflow.js":
/*!*************************************************!*\
  !*** ./src/components/ow-submit-to-workflow.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SubmitToWorkflow": () => (/* binding */ SubmitToWorkflow),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _images_help_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../images/help.png */ "./src/images/help.png");
/* harmony import */ var _ow_due_date_picker__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ow-due-date-picker */ "./src/components/ow-due-date-picker.js");
/* harmony import */ var _ow_due_date_label__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ow-due-date-label */ "./src/components/ow-due-date-label.js");
/* harmony import */ var _ow_task_priority_select_control__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ow-task-priority-select-control */ "./src/components/ow-task-priority-select-control.js");
/* harmony import */ var _ow_workflow_select_control__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ow-workflow-select-control */ "./src/components/ow-workflow-select-control.js");
/* harmony import */ var _ow_team_select_control__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ow-team-select-control */ "./src/components/ow-team-select-control.js");
/* harmony import */ var _ow_pre_publish_checklist__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ow-pre-publish-checklist */ "./src/components/ow-pre-publish-checklist.js");
...
var SubmitToWorkflow = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(SubmitToWorkflow, _Component);

  var _super = _createSuper(SubmitToWorkflow);

  function SubmitToWorkflow() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, SubmitToWorkflow);

    _this = _super.apply(this, arguments);
    _this.submitToWorkflowPanelRef = createRef(); // Set default first step dropdown state
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(SubmitToWorkflow, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var customWorkflowTerminology = this.props.owSettings.terminology_settings.oasiswf_custom_workflow_terminology;
      var workflowSettings = this.props.owSettings.workflow_settings;
      ...
      if (customWorkflowTerminology) {
        var workflowButtonText = customWorkflowTerminology.submitToWorkflowText;
        var assignActorLabel = customWorkflowTerminology.assignActorsText;
        var publishDateLabel = customWorkflowTerminology.publishDateText;
        var dueDateLabel = customWorkflowTerminology.dueDateText;
        var continueToSubmitText = customWorkflowTerminology.continueToSubmitText;
        this.setState({
          workflowButtonText: workflowButtonText,
          assignActorLabel: assignActorLabel,
          publishDateLabel: publishDateLabel,
          dueDateLabel: dueDateLabel,
          continueToSubmitText: continueToSubmitText
        });
      }

      if (workflowSettings) {
        var displayPublishDate = workflowSettings.oasiswf_publish_date_setting;
        var displayDueDate = workflowSettings.oasiswf_default_due_days;
        var mandatoryComments = workflowSettings.oasiswf_comments_setting; // set the default due date by using the workflow settings
    ...
    key: "getFirstStep",
    value: function getFirstStep(workflowId) {
      var _this2 = this;

      var postId = this.props.postId; // Set selected workflow
      ...
      wp.apiFetch({
        ...
        var firstStepId = stepdata.step_id;
        var firstStepLabel = stepdata.step_label;
        var firstSteps = [];
        var availableAssignees = [];
        var assignToAll = stepdata.assign_to_all === 1 ? true : false;
        var errors = [];
        ...
        if (teams !== "") {
          ...
          if (allTeams.length == 1) {
            ...
            _this2.handleTeamChange(allTeams[0]["value"], null, firstStepId);
          }
        ...
        if (teams == "") {
          ...
          if (assignees.length === 0) {
            ...
            _this2.submitToWorkflowPanelRef.current.scrollIntoView();

            return;
          } // Set and Get Assignees from the util function


          var stepAssignees = (0,_util__WEBPACK_IMPORTED_MODULE_15__.getStepAssignees)({
            assignees: assignees,
            assignToAll: assignToAll
          });
          availableAssignees = stepAssignees.availableAssignees;
    ...
    key: "handleTeamChange",
    value: function handleTeamChange(selectedTeam, event) {
      var _this3 = this;

      var firstStepId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      var postId = this.props.postId;
      ...
      wp.apiFetch({
        ...
        if (assignees.length === 0) {
          ...
          _this3.submitToWorkflowPanelRef.current.scrollIntoView();
        ...
        var stepAssignees = (0,_util__WEBPACK_IMPORTED_MODULE_15__.getStepAssignees)({
          assignees: assignees,
          assignToAll: _this3.state.assignToAll
        });
    ...
    key: "validateSubmitToWorkflow",
    value: function validateSubmitToWorkflow(data) {
      var errors = [];
      var current_date = new Date();
      current_date = moment(current_date).format("YYYY-MM-DD");
      var due_date = moment(data.due_date).format("YYYY-MM-DD");
      var selected_workflow = this.state.selectedWorkflow;
      var selected_step = this.state.selectedFirstStep;
    ...
    key: "handleContinueToSubmit",
    value: function handleContinueToSubmit(event) {
      var _this4 = this;
      ...
      this.setState({
        ...
        _this4.handleSubmitToWorkflow();
      });
    } // Submit to workflow - form submit

  }, {
    key: "handleSubmitToWorkflow",
    value: function () {
      var _handleSubmitToWorkflow = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default().mark(function _callee(event) {
        var form_data, errors, that;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_7___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                errors = this.validateSubmitToWorkflow(form_data);
      ...
      function handleSubmitToWorkflow(_x) {
        return _handleSubmitToWorkflow.apply(this, arguments);
      }

      return handleSubmitToWorkflow;
    }()
  }, {
    key: "invokeSubmitToWorkflowAPI",
    value: function invokeSubmitToWorkflowAPI(form_data) {
      var _this5 = this;
      ...
      wp.apiFetch({
        ...
        if (submitResponse.success_response == false) {
          ...
          _this5.submitToWorkflowPanelRef.current.scrollIntoView();
        } else {
          _this5.setState({
            hideForm: true,
            redirectingLoader: "show"
          ...
          if (submitResponse.redirect_link !== "") {
            window.location.href = dompurify__WEBPACK_IMPORTED_MODULE_16___default().sanitize(submitResponse.redirect_link);
          } else {
            _this5.props.handleResponse(submitResponse);
          }
        }
      }, function (err) {
        console.log(err);
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          errorType = _this$state.errorType,
          hideForm = _this$state.hideForm,
          workflowButtonText = _this$state.workflowButtonText,
          continueToSubmitText = _this$state.continueToSubmitText,
          assignActorLabel = _this$state.assignActorLabel,
          publishDateLabel = _this$state.publishDateLabel,
          dueDateLabel = _this$state.dueDateLabel,
          displayPublishDate = _this$state.displayPublishDate,
          displayDueDate = _this$state.displayDueDate,
          articleChecklist = _this$state.articleChecklist,
          redirectingLoader = _this$state.redirectingLoader,
          stepSpinner = _this$state.stepSpinner,
      ...
      if (postMeta && postMeta._oasis_is_in_workflow == "1" || isPostInWorkflow || // post is in another workflow
      hideForm || isCurrentPostPublished || // a new post is published
      ...
      return /*#__PURE__*/React.createElement(PanelBody, {
      ...
      }, continueToSubmitText)) : "") : "", /*#__PURE__*/React.createElement(_ow_workflow_select_control__WEBPACK_IMPORTED_MODULE_12__["default"], {
        ...
        src: _images_help_png__WEBPACK_IMPORTED_MODULE_8__["default"],
        className: "help-icon"
      })))), /*#__PURE__*/React.createElement(SelectControl, {
        value: this.state.selectedFirstStep,
        options: this.state.firstSteps,
        onChange: function onChange(selectedFirstStep) {
          return _this6.setState({
            selectedFirstStep: selectedFirstStep
          });
        }
      }), /*#__PURE__*/React.createElement(_ow_task_priority_select_control__WEBPACK_IMPORTED_MODULE_11__["default"], {
        value: this.state.selectedPriority,
        onChange: this.handleOnPriorityChange.bind(this)
      }), this.state.allTeams.length !== 0 ? /*#__PURE__*/React.createElement(_ow_team_select_control__WEBPACK_IMPORTED_MODULE_13__["default"], {
        value: this.state.selectedTeam,
        options: this.state.allTeams,
        onChange: this.handleTeamChange.bind(this)
      }) : "", /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, assigneeSpinner == "show" && this.state.assignToAll == false ? /*#__PURE__*/React.createElement(Spinner, null) : ""), !this.state.assignToAll && this.state.selectedWorkflow !== "" ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
        htmlFor: 'assignActor'
      }, assignActorLabel + ":"), /*#__PURE__*/React.createElement(react_select__WEBPACK_IMPORTED_MODULE_17__["default"], {
        inputId: "assignActor",
        styles: style,
        className: "ow-select2",
        value: this.state.selectedAssignees,
        ...
        isMulti: "true"
      })) : "", articleChecklist.length !== 0 ? /*#__PURE__*/React.createElement(_ow_pre_publish_checklist__WEBPACK_IMPORTED_MODULE_14__["default"], {
        checklist: articleChecklist,
        onChange: this.selectPrePublishChecklist.bind(this)
      }) : "", displayPublishDate == "" ? /*#__PURE__*/React.createElement(PanelRow, {
        className: "edit-post-post-schedule"
      }, /*#__PURE__*/React.createElement("label", null, publishDateLabel + ":", " "), /*#__PURE__*/React.createElement(Dropdown, {
        position: "bottom left",
        contentClassName: "edit-post-post-schedule__dialog",
        renderToggle: function renderToggle(_ref) {
          var onToggle = _ref.onToggle,
      ...
      }, workflowButtonText), /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, submitSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""))));
    }
  }]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose([withSelect(function (select) {
  ...
  var _select2 = select("plugin/oasis-workflow"),
      ...
      getOWSettings = _select2.getOWSettings,
      getPostInWorkflow = _select2.getPostInWorkflow,
      getassignees = _select2.getassignees;
...
}), withSafeTimeout])(SubmitToWorkflow));

/***/ }),

/***/ "./src/components/ow-task-priority-select-control.js":
/*!***********************************************************!*\
  !*** ./src/components/ow-task-priority-select-control.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/esm/possibleConstructorReturn.js");
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js");
/* harmony import */ var _images_help_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../images/help.png */ "./src/images/help.png");
...
var TaskPriorities = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(TaskPriorities, _Component);

  var _super = _createSuper(TaskPriorities);

  function TaskPriorities() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, TaskPriorities);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(TaskPriorities, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      if (customWorkflowTerminology) {
        var priorityLabel = customWorkflowTerminology.taskPriorityText;
        this.setState({
      ...
      if (workflowSettings) {
        var displayPriority = workflowSettings.oasiswf_priority_setting;
        this.setState({
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/priorities",
        method: "GET"
      }).then(function (data) {
        var priorityData = data.map(function (priority) {
          return pick(priority, ["key", "value"]);
        });
        var priorities = [];
        priorityData.map(function (priority) {
          priorities.push({
    ...
    value: function render() {
      var _this$state = this.state,
          priorityLabel = _this$state.priorityLabel,
          displayPriority = _this$state.displayPriority;
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, this.state.prioritySpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""), displayPriority === "enable_priority" ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", null, priorityLabel + ": ", /*#__PURE__*/React.createElement("a", {
        href: "#",
        title: __("Post/Article Priority", "oasisworkflow"),
        className: "tooltip"
      }, /*#__PURE__*/React.createElement("span", {
        title: ""
      }, /*#__PURE__*/React.createElement("img", {
        src: _images_help_png__WEBPACK_IMPORTED_MODULE_5__["default"],
        className: "help-icon"
      })))), /*#__PURE__*/React.createElement(SelectControl, {
        value: this.props.value,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (compose([withSelect(function (select) {
  var _select = select("plugin/oasis-workflow"),
      getOWSettings = _select.getOWSettings;
...
/***/ "./src/components/ow-team-select-control.js":
/*!**************************************************!*\
  !*** ./src/components/ow-team-select-control.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TeamSelectControl": () => (/* binding */ TeamSelectControl),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var withSelect = wp.data.withSelect;
var compose = wp.compose.compose;
var TeamSelectControl = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(TeamSelectControl, _Component);

  var _super = _createSuper(TeamSelectControl);

  function TeamSelectControl() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, TeamSelectControl);

    return _super.apply(this, arguments);
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(TeamSelectControl, [{
    key: "render",
    value: function render() {
...
/***/ "./src/components/ow-workflow-select-control.js":
/*!******************************************************!*\
  !*** ./src/components/ow-workflow-select-control.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WorkflowSelectControl": () => (/* binding */ WorkflowSelectControl),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
...
var _lodash = lodash,
    pick = _lodash.pick;
var WorkflowSelectControl = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(WorkflowSelectControl, _Component);

  var _super = _createSuper(WorkflowSelectControl);

  function WorkflowSelectControl() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, WorkflowSelectControl);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WorkflowSelectControl, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      var postId = this.props.postId;
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows" + "/postId=" + postId,
        method: "GET"
      }).then(function (data) {
        var workflowData = data.map(function (workflow) {
          return pick(workflow, ["ID", "name", "version"]);
        });
        var workflows = [];
        ...
        workflowData.map(function (workflow) {
          ...
          if (workflowData.length == 1) {
            ...
            _this2.props.onChange(workflow.ID);
          }
        });
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        className: "owf-spinner"
      }, this.state.workflowSpinner == "show" ? /*#__PURE__*/React.createElement(Spinner, null) : ""), /*#__PURE__*/React.createElement(SelectControl, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OasisWorkflowProComponent": () => (/* binding */ OasisWorkflowProComponent)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/esm/createClass.js");
/* harmony import */ var _babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/assertThisInitialized */ "./node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js");
...
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/esm/possibleConstructorReturn.js");
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js");
/* harmony import */ var _components_ow_abort__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/ow-abort */ "./src/components/ow-abort.js");
/* harmony import */ var _components_ow_submit_to_workflow__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/ow-submit-to-workflow */ "./src/components/ow-submit-to-workflow.js");
/* harmony import */ var _components_ow_signoff_response__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/ow-signoff-response */ "./src/components/ow-signoff-response.js");
/* harmony import */ var _components_ow_claim__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/ow-claim */ "./src/components/ow-claim.js");
/* harmony import */ var _components_ow_signoff__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/ow-signoff */ "./src/components/ow-signoff.js");
/* harmony import */ var _components_ow_make_revision__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/ow-make-revision */ "./src/components/ow-make-revision.js");
/* harmony import */ var _components_ow_compare_revision__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/ow-compare-revision */ "./src/components/ow-compare-revision.js");
/* harmony import */ var _components_ow_reassign__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/ow-reassign */ "./src/components/ow-reassign.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./util */ "./src/util.js");
/* harmony import */ var _components_custom_post_type_support__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/custom-post-type-support */ "./src/components/custom-post-type-support.js");
/* harmony import */ var _components_ow_editorial_comments__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/ow-editorial-comments */ "./src/components/ow-editorial-comments.js");
...
var OasisWorkflowProComponent = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(OasisWorkflowProComponent, _Component);

  var _super = _createSuper(OasisWorkflowProComponent);

  function OasisWorkflowProComponent() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, OasisWorkflowProComponent);

    _this = _super.apply(this, arguments);
    _this.pluginSettings = null;
    _this.submitButtonText = "";
    _this.state = {
      submitToWorkflowResponse: "",
      signOffResponse: "",
      hideSignoff: false,
      actionHistoryId: (0,_util__WEBPACK_IMPORTED_MODULE_14__.getActionHistoryIdFromURL)(),
    ...
    _this.showWorkflowSideBar = _this.showWorkflowSideBar.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this));
    return _this;
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(OasisWorkflowProComponent, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      ...
      if (this.props.postMeta == undefined) {
        var hidePluginMessage = /*#__PURE__*/React.createElement(_components_custom_post_type_support__WEBPACK_IMPORTED_MODULE_15__["default"], null);
        this.setState({
          hidePlugin: true,
          hidePluginMessage: hidePluginMessage
        });
        return;
      ...
      this.props.setIsPostInWorkflow({
        isPostInWorkflow: this.props.postMeta._oasis_is_in_workflow
      ...
      wp.apiFetch({
        path: "/oasis-workflow/v1/workflows/submit/checkRoleCapability/postId=" + this.props.postId + "/postType=" + this.props.postType,
        method: "GET"
      }).then(function (response) {
        if (response.can_skip_workflow && !_this2.props.postMeta._oasis_original || !response.is_role_applicable) {
        ...
        if (response.is_role_applicable && response.can_submit_to_workflow) {
          ...
          var id = setInterval(function () {
            if (!isEmpty(that.props.owSettings) && !isEmpty(that.props.userCap)) {
              ...
              var workflowSettings = that.props.owSettings.workflow_settings;
              var showWorkflowSidebar = "hide";
              ...
              if ((that.state.actionHistoryId || that.props.isCurrentPostPublished || that.props.isCurrentPostScheduled) && showWorkflowSidebar === "show") {
              ...
              if (!that.state.actionHistoryId && !that.props.postMeta._oasis_is_in_workflow && response.can_submit_to_workflow) {
                ...
                workflowButtonDiv.innerHTML = "<button type=\"button\" aria-label=\"".concat(that.submitButtonText, "\"\n                                    class=\"owf-submit-button components-button is-primary is-button is-large\">\n                                    ").concat(that.submitButtonText, "</button>");
                ...
                for (var i = 0; i < headerBarChildElements.length; i++) {
                  if (typeof headerBarChildElements[i].className.indexOf === "function" && headerBarChildElements[i].className.indexOf("editor-post-publish-panel") !== -1) {
                    headerBarChildElements[i].parentNode.insertBefore(workflowButtonDiv, headerBarChildElements[i].nextSibling);
          ...
          var _hidePluginMessage = __("Workflow actions are not available for this post type.", "oasisworkflow");

          if (!response.can_submit_to_workflow) {
            _hidePluginMessage = __("You are not allowed to submit to workflow.", "oasisworkflow");
          }

          _this2.setState({
            hidePlugin: true,
            hidePluginMessage: _hidePluginMessage
          });
        }
      }, function (err) {
        var hidePluginMessage = __("You are not allowed to submit to workflow.", "oasisworkflow");
    ...
    key: "showWorkflowSideBar",
    value: function showWorkflowSideBar() {
    ...
    key: "handleWorkflowAbortResponse",
    value: function handleWorkflowAbortResponse() {
      this.setState({
        submitToWorkflowResponse: "",
        signOffResponse: ""
      });
    ...
    key: "handleSubmitToWorkflowResponse",
    value: function handleSubmitToWorkflowResponse(response) {
      this.setState({
      ...
      this.props.setIsPostInWorkflow({
        isPostInWorkflow: response.post_is_in_workflow
      });
    }
    /**
    ...
    key: "handleSignoffResponse",
    value: function handleSignoffResponse(response) {
      this.setState({
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          submitToWorkflowResponse = _this$state.submitToWorkflowResponse,
          signOffResponse = _this$state.signOffResponse,
          actionHistoryId = _this$state.actionHistoryId,
          hideClaimButton = _this$state.hideClaimButton,
          hideCompareButton = _this$state.hideCompareButton,
          hidePlugin = _this$state.hidePlugin,
          hidePluginMessage = _this$state.hidePluginMessage,
          hideSignoff = _this$state.hideSignoff;
      var isEditorialCommentActive = this.props.isEditorialCommentActive;
      ...
      }, __("Oasis Workflow", "oasisworkflow")), /*#__PURE__*/React.createElement(PluginSidebar, {
        name: "ow-workflow-sidebar",
        title: __("Oasis Workflow", "oasisworkflow")
      }, hidePlugin ? /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement("div", {
        id: "owf-warning-message",
        className: "notice notice-error"
      }, hidePluginMessage)) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_components_ow_signoff_response__WEBPACK_IMPORTED_MODULE_8__["default"], {
        response: signOffResponse
      }), /*#__PURE__*/React.createElement("div", null, !hideSignoff && actionHistoryId !== null && hideClaimButton ? /*#__PURE__*/React.createElement(_components_ow_signoff__WEBPACK_IMPORTED_MODULE_10__["default"], {
        handleResponse: this.handleSignoffResponse.bind(this)
      }) : ""), /*#__PURE__*/React.createElement(_components_ow_signoff_response__WEBPACK_IMPORTED_MODULE_8__["default"], {
        response: submitToWorkflowResponse
      }), /*#__PURE__*/React.createElement(_components_ow_submit_to_workflow__WEBPACK_IMPORTED_MODULE_7__["default"], {
        handleResponse: this.handleSubmitToWorkflowResponse.bind(this)
      }), actionHistoryId !== null ? /*#__PURE__*/React.createElement(_components_ow_reassign__WEBPACK_IMPORTED_MODULE_13__["default"], null) : "", /*#__PURE__*/React.createElement(_components_ow_claim__WEBPACK_IMPORTED_MODULE_9__["default"], {
        isHidden: hideClaimButton,
        actionHistoryId: actionHistoryId,
        onClaim: function onClaim() {
          return _this3.setState(function (state) {
            return {
              hideClaimButton: !state.hideClaimButton
            };
          });
        }
      }), /*#__PURE__*/React.createElement(_components_ow_abort__WEBPACK_IMPORTED_MODULE_6__["default"], {
        handleResponse: this.handleWorkflowAbortResponse.bind(this)
      }), /*#__PURE__*/React.createElement(_components_ow_make_revision__WEBPACK_IMPORTED_MODULE_11__["default"], null), /*#__PURE__*/React.createElement(_components_ow_compare_revision__WEBPACK_IMPORTED_MODULE_12__["default"], {
        isHidden: hideCompareButton
      }), isEditorialCommentActive ? /*#__PURE__*/React.createElement(_components_ow_editorial_comments__WEBPACK_IMPORTED_MODULE_16__["default"], null) : "")));
    }
  }]);

  return OasisWorkflowProComponent;
}(Component);
var HOC = compose([withSelect(function (select) {
  var _select = select("core/editor"),
      getCurrentPostId = _select.getCurrentPostId,
      getCurrentPostType = _select.getCurrentPostType,
      isCurrentPostPublished = _select.isCurrentPostPublished,
  ...
  var _select3 = select("plugin/oasis-workflow"),
      getOWSettings = _select3.getOWSettings,
      getUserCapabilities = _select3.getUserCapabilities,
      getEditorialCommentsActivation = _select3.getEditorialCommentsActivation;
...
})])(OasisWorkflowProComponent); // const HOC = withDispatch((dispatch) => ({
// 	onSave: dispatch('core/editor').savePost
// }))(OasisWorkflowProComponent);

registerPlugin("oasis-workflow-pro-plugin", {
  icon: _util__WEBPACK_IMPORTED_MODULE_14__.pluginIcon,
  render: HOC
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fetchEditorialCommentsActivation": () => (/* binding */ fetchEditorialCommentsActivation),
/* harmony export */   "fetchOWSettings": () => (/* binding */ fetchOWSettings),
/* harmony export */   "fetchUserCapabilities": () => (/* binding */ fetchUserCapabilities),
/* harmony export */   "setDueDate": () => (/* binding */ setDueDate),
/* harmony export */   "setEditorialCommentsActivation": () => (/* binding */ setEditorialCommentsActivation),
/* harmony export */   "setIsPostInWorkflow": () => (/* binding */ setIsPostInWorkflow),
/* harmony export */   "setOWSettings": () => (/* binding */ setOWSettings),
/* harmony export */   "setUserCapabilities": () => (/* binding */ setUserCapabilities)
/* harmony export */ });
var _lodash = lodash,
    pick = _lodash.pick;
/**
...
function setOWSettings(owSettings) {
  return {
...
function fetchUserCapabilities(path) {
  return {
...
function setUserCapabilities(userCap) {
  return {
...
function setIsPostInWorkflow(data) {
...
/**
 * Fetches Editorial Comment Activation
 */

function fetchEditorialCommentsActivation(path) {
  return {
    type: "FETCH_EDITORIAL_COMMENTS_ACTIVATION",
    path: path
  };
}
/**
 * Check Editorial Comment Activation
 * @param {*} activation
 */

function setEditorialCommentsActivation(activation) {
  var isActive = false;
  ...
  return {
    type: "SET_EDITORIAL_COMMENTS_ACTIVATION",
    isEditorialCommentsActive: isActive
  };
}

/***/ }),

/***/ "./src/store/ow-store.js":
/*!*******************************!*\
  !*** ./src/store/ow-store.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 * WordPress Dependencies
 */
var registerStore = wp.data.registerStore; // const { apiFetch } = wp.apiFetch;
...
var MODULE_KEY = "plugin/oasis-workflow";
var store = registerStore(MODULE_KEY, {
  reducer: _reducer__WEBPACK_IMPORTED_MODULE_1__["default"],
  selectors: _selectors__WEBPACK_IMPORTED_MODULE_2__,
  actions: _actions__WEBPACK_IMPORTED_MODULE_3__,
  controls: {
    FETCH_OW_SETTINGS: function FETCH_OW_SETTINGS(action) {
      return wp.apiFetch({
        path: action.path
      });
    },
    FETCH_USER_CAPABILITIES: function FETCH_USER_CAPABILITIES(action) {
      return wp.apiFetch({
        path: action.path
      });
    },
    FETCH_EDITORIAL_COMMENTS_ACTIVATION: function FETCH_EDITORIAL_COMMENTS_ACTIVATION(action) {
      return wp.apiFetch({
        path: action.path
      });
    }
  ...
  resolvers: {
    getOWSettings: /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function getOWSettings() {
      var path, owSettings;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function getOWSettings$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              path = "/oasis-workflow/v1/settings";
              _context.next = 3;
              return _actions__WEBPACK_IMPORTED_MODULE_3__.fetchOWSettings(path);

            case 3:
              owSettings = _context.sent;
              return _context.abrupt("return", _actions__WEBPACK_IMPORTED_MODULE_3__.setOWSettings(owSettings));
    ...
    getUserCapabilities: /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function getUserCapabilities() {
      var path, userCap;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function getUserCapabilities$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              path = "/oasis-workflow/v1/usercap";
              _context2.next = 3;
              return _actions__WEBPACK_IMPORTED_MODULE_3__.fetchUserCapabilities(path);

            case 3:
              userCap = _context2.sent;
              return _context2.abrupt("return", _actions__WEBPACK_IMPORTED_MODULE_3__.setUserCapabilities(userCap));
    ...
    getEditorialCommentsActivation: /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function getEditorialCommentsActivation() {
      var path, activation;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function getEditorialCommentsActivation$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              path = "/oasis-workflow/v1/editorialComments";
              _context3.next = 3;
              return _actions__WEBPACK_IMPORTED_MODULE_3__.fetchEditorialCommentsActivation(path);

            case 3:
              activation = _context3.sent;
              return _context3.abrupt("return", _actions__WEBPACK_IMPORTED_MODULE_3__.setEditorialCommentsActivation(activation));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DEFAULT_DUE_DATE": () => (/* binding */ DEFAULT_DUE_DATE),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "dueDateReducer": () => (/* binding */ dueDateReducer),
/* harmony export */   "editorialCommentReducer": () => (/* binding */ editorialCommentReducer),
/* harmony export */   "owSettingsReducer": () => (/* binding */ owSettingsReducer),
/* harmony export */   "postInWorkflowReducer": () => (/* binding */ postInWorkflowReducer),
/* harmony export */   "userCapabilitiesReducer": () => (/* binding */ userCapabilitiesReducer)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
 ...
 * WordPress dependencies
 */
var combineReducers = wp.data.combineReducers;
var DEFAULT_DUE_DATE = {
  dueDate: new Date()
}; // set current date as due date

var DEFAULT_OW_SETTINGS = {
  owSettings: {}
};
var DEFAULT_USER_SETTINGS = {
  userCap: {}
};
var DEFAULT_POST_IN_WORKFLOW = {
  isPostInWorkflow: false
};
var DEFAULT_EDITORIAL_COMMENTS_ACTIVATION = {
...
function dueDateReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_DUE_DATE;
...
function owSettingsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_OW_SETTINGS;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
function userCapabilitiesReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_USER_SETTINGS;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
function postInWorkflowReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_POST_IN_WORKFLOW;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
/**
 * Reducer keeping track of is Editorial Comments addon active
 * @param {Object} state Previous state.
 * @param {Object} action Action object.
 */

function editorialCommentReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_EDITORIAL_COMMENTS_ACTIVATION;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (combineReducers({
  dueDateReducer: dueDateReducer,
  owSettingsReducer: owSettingsReducer,
  userCapabilitiesReducer: userCapabilitiesReducer,
  postInWorkflowReducer: postInWorkflowReducer,
  editorialCommentReducer: editorialCommentReducer
}));
...
/* harmony export */   "getEditorialCommentsActivation": () => (/* binding */ getEditorialCommentsActivation),
/* harmony export */   "getOWSettings": () => (/* binding */ getOWSettings),
/* harmony export */   "getPostInWorkflow": () => (/* binding */ getPostInWorkflow),
/* harmony export */   "getUserCapabilities": () => (/* binding */ getUserCapabilities)
/* harmony export */ });
/**
 ...
 */
function getDueDate(state) {
  var dueDateReducer = state.dueDateReducer;
...
function getOWSettings(state) {
  var owSettingsReducer = state.owSettingsReducer;
...
function getUserCapabilities(state) {
  var userCapabilitiesReducer = state.userCapabilitiesReducer;
...
function getPostInWorkflow(state) {
  var postInWorkflowReducer = state.postInWorkflowReducer;
  return postInWorkflowReducer.isPostInWorkflow;
}
/**
 * Returns addon activation from the store
 * @param {Object} state
 */

function getEditorialCommentsActivation(state) {
  var editorialCommentReducer = state.editorialCommentReducer;
  return editorialCommentReducer.isEditorialCommentsActive;
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getActionHistoryIdFromURL": () => (/* binding */ getActionHistoryIdFromURL),
/* harmony export */   "getPostTypeFromURL": () => (/* binding */ getPostTypeFromURL),
/* harmony export */   "getSignOffActions": () => (/* binding */ getSignOffActions),
/* harmony export */   "getStepAssignees": () => (/* binding */ getStepAssignees),
/* harmony export */   "getTaskUserFromURL": () => (/* binding */ getTaskUserFromURL),
...
function getActionHistoryIdFromURL() {
  var params = new RegExp("[?&]oasiswf=([^&#]*)").exec(dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(window.location.href));

  if (params == null) {
    var oasiswf_id = document.getElementById('hi_oasiswf_id');
...
function getPostTypeFromURL() {
  var params = new RegExp("[?&]post_type=([^&#]*)").exec(dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(window.location.href));
  console.log(params);
...
function getTaskUserFromURL() {
  var params = new RegExp("[?&]user=([^&#]*)").exec(dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(window.location.href));
...
function getSignOffActions(success_action, failure_action) {
  var actions = [];
  actions.push({
    label: "",
    value: ""
...
function getStepAssignees(data) {
  var assignees = data.assignees;
  var availableAssignees = [];
  var selectedAssignees = [];
  var isAssignToAll = data.assignToAll; // Sort Post Author at top of the assignee list
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/png;base64,");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ow_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ow-style.scss */ "./src/ow-style.scss");
/* harmony import */ var _store_ow_store_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store/ow-store.js */ "./src/store/ow-store.js");
/* harmony import */ var _ow_sidebar_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ow-sidebar.js */ "./src/ow-sidebar.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./util.js */ "./src/util.js");
// import stylesheet
 // import oasis workflow redux store

 // import Oasis Workflow Sidebar
