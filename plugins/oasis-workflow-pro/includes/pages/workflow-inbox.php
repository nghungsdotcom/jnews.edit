        ...
        <div class="tablenav top">
                ...
                <div class="tablenav">
                    <ul class="subsubsub">
                        ...
                        <li id="owf_inbox_all"><a <?php echo $all; // phpcs:ignore ?>
                                href="javascript:window.open('<?php echo esc_url( admin_url( 'admin.php?page=oasiswf-inbox&action=inbox-all&user=' ) ); ?>' + <?php echo esc_attr( $selected_user ) ?> <?php echo esc_attr( $due_date ); ?> + '&priority=' + jQuery('#inbox_priority_filter').val(), '_self')" <?php echo esc_attr( $all ); ?>
                        ...
                        <li id="owf_inbox_mine"><a <?php echo $mine; // phpcs:ignore ?>
                                href="javascript:window.open('<?php echo esc_url( admin_url( 'admin.php?page=oasiswf-inbox&action=inbox-mine&user=' ) ); ?>' + <?php echo esc_attr( $selected_user ); ?> <?php echo esc_attr( $due_date ); ?> + '&priority=' + jQuery('#inbox_priority_filter').val(), '_self')" <?php echo esc_attr( $mine ); ?>
                        ...
                        <li id="owf_inbox_unclaimed"><a <?php echo $unclaimed; // phpcs:ignore ?>
                                href="javascript:window.open('<?php echo esc_url( admin_url( 'admin.php?page=oasiswf-inbox&action=inbox-unclaimed&user=' ) ); ?>' + <?php echo esc_attr( $selected_user ); ?> <?php echo esc_attr( $due_date ); ?> + '&priority=' + jQuery('#inbox_priority_filter').val(), '_self')" <?php echo esc_attr( $unclaimed ); ?>
			...
			<?php if ( current_user_can( 'ow_view_others_inbox' ) ) { ?>
                <div class="tablenav alignleft actions">
                    ...
                    <a href="javascript:window.open('<?php echo esc_url( admin_url( 'admin.php?page=oasiswf-inbox&action=' .
	                                                                                $action .
	                                                                                '&user=' ) ); ?>' + jQuery('#inbox_filter').val()<?php echo esc_attr( $due_date ); ?> + '&priority=' + jQuery('#inbox_priority_filter').val(), '_self')">
                        <input type="button" class="button-secondary action"
                               value="<?php esc_attr_e( "Show", "oasisworkflow" ); ?>"/>
                    </a>
                </div>
			<?php } ?>
            <div class="tablenav alignleft actions">
