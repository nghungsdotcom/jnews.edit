...
$action = ( isset( $_GET['show_unclaimed'] ) && intval( $_GET["show_unclaimed"] ) ) ? intval( $_GET["show_unclaimed"] ) : 0;
...
$action_url = wp_nonce_url( admin_url( 'admin.php?page=oasiswf-history' ), 'owf-workflow-history', 'security' );
?>
<div class="wrap">
        ...
        <div class="tablenav">
            <form method="post"
                ...
                <div class="alignleft actions">
                    ...
                    <a href="javascript:window.open('<?php echo esc_url( admin_url( 'admin.php?page=oasiswf-history&post=' ) ); ?>' + jQuery('#post_filter').val() + '<?php echo '&show_unclaimed=' .
					                                                                                                                                                             esc_attr( $action ) .
					                                                                                                                                                             '&_wpnonce=' .
					                                                                                                                                                             esc_attr( wp_create_nonce( 'owf_view_history_nonce' ) ); ?>', '_self')">
                        <input type="button" class="button-secondary action"
                               value="<?php echo esc_attr__( "Filter", "oasisworkflow" ); ?>"/>
                    </a>&nbsp;
					...
					?>
                    <a href="javascript:window.open('<?php echo esc_url( admin_url( 'admin.php?page=oasiswf-
