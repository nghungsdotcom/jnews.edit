...
class OW_History_Service {
	...
	public function get_table_header() {
		...
		<a href='admin.php?page=oasiswf-history&orderby=post_title&order=" . esc_attr( $order )
		     . esc_attr( $where_post ) . "'>
		...
		<a href='admin.php?page=oasiswf-history&orderby=wf_name&order=" . esc_attr( $order ) . esc_attr( $where_post ) . "'>
					<span>" . esc_html__( "Workflow [Step]", "oasisworkflow" ) . "</span>
					<span class='sorting-indicator'></span>
				</a>
			</th>";
		echo "<th scope='col' class='sorted " . esc_attr( $create_date_order_class ) . "'>
		<a href='admin.php?page=oasiswf-history&orderby=create_datetime&order=" . esc_attr( $order ) .
		     esc_attr( $where_post ) . "'>
