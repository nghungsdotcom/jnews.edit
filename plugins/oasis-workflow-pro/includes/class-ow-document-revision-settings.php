                ...
                <div id="settingstuff">
                    ...
                    <div class="select-info">
                        ...
                        <input type="checkbox"
                               ...
                               value="yes" <?php echo esc_html__( $check ); ?>/>&nbsp;&nbsp;
                        <label
                    ...
                    <div class="select-info">
                        ...
                        <input type="checkbox" id="<?php echo esc_attr( $this->ow_hide_compare_button_option_name ); ?>"
                               ...
                               value="yes" <?php echo esc_html__( $check ); ?>/>&nbsp;&nbsp;
                        <label class="settings-title"><?php echo esc_html__( "Hide Compare Button?",
								"oasisworkflow" ); ?> </label>
                    </div>
                    
					<div class="select-info">
						<?php $check = ( $disable_workflow_4_revision == "yes" ) ? ' checked="checked" ' : ''; ?>
